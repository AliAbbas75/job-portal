...
/** Published jobs matching filters: { q, sort, bps, department, employmentType, location, qualification, closing, page, pageSize }. */
...
/** Counts for the landing page: { openJobs, vacancies, departments, locations }. */
