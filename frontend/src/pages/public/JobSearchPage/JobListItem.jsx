...
export function JobListItem({ job }) {
  ...
  return (
    <li
      className={`group relative grid grid-cols-1 items-center gap-x-5 gap-y-4 border-b border-l-4 [border-bottom-style:dashed] border-b-heritage py-5 pr-0 pl-3 hover:bg-surface md:grid-cols-[1fr_auto] md:pr-3 md:pl-4 ${closingSoon ? 'border-l-ember' : 'border-l-transparent'}`}
    >
